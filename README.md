...
| `-m, --model <name>`                                            | Built-ins (`gpt-5.5-pro` default, `o3-deep-research` / `o4-mini-deep-research` for API Deep Research, `deepresearch` as browser Deep research shorthand when browser engine is selected, `gpt-5.4-pro` legacy Pro alias, `gpt-5.4`, `gpt-5.1-pro`, `gpt-5-pro`, `gpt-5.1`, `gpt-5.1-codex`, `gpt-5.2`, `gpt-5.2-instant`, `gpt-5.2-pro`, `gemini-3.1-pro` API-only, `gemini-3-pro`, `claude-4.5-sonnet`, `claude-4.1-opus`) plus any OpenRouter id. |
...
| `--browser-model-label <label>`                                 | Exact ChatGPT model picker label to select in browser mode, e.g. `Pro`. Use `--browser-thinking-time extended` for GPT-5.5 Pro extended thinking.                                                                                                                                                                                                                                                                                                   |
